...
actionTypes = get_actions_from_odrl("./media/default_ontology/ODRL22.rdf")
actorTypes = get_actors_from_dpv("./media/default_ontology/dpv.rdf")
purposeTypes = get_purposes_from_dpv("./media/default_ontology/dpv.rdf")
